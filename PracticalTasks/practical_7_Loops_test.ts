...
Scenario("PZ7 @C073 Loops - counter", () => {
  ...
  function sortNumbersDescending2(numbers: number[]): number[] {
  ...
  const sortedResult21: number[] = sortNumbersDescending2(inputNumbers1);
  console.log(sortedResult21);
  const sortedResult22: number[] = sortNumbersDescending2([77, 0.7, 7, 0, -17]);
  console.log(sortedResult22);
  ...
  console.log(sortNumbers(5, 2, 4, 7));
  console.log(sortNumbers(-4, 12, 5, 0));
  console.log(sortNumbers(5));
  console.log(sortNumbers(0, 1, 2, 3, 4, 5));
});
